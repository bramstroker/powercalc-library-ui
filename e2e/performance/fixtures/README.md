...
The performance fixture API serves this full dataset for browsing. The growth
scenario duplicates each model four times with unique IDs (2,996 profiles) to test CPU/render
cost. That scenario intercepts the library API response and does not measure network payload growth.
