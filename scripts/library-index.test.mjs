...
test("retains catalogue identity and filter metadata while removing detail payloads", () => {
  const model = { id: "bulb", legacy_ids: ["old"], aliases: ["TRÅDFRI"], ean: ["123"],
    device_specs: { socket: ["E27"], lumens: 800 }, voltage_range: { min: 225, max: 235 },
    authors: [{ name: "Bram", github: "bramstroker" }], description: "Long detail",
    measure_settings: { samples: 100 }, measure_description: "Measurements", hash: "abc" };
  ...
  for (const key of ["id", "legacy_ids", "aliases", "ean", "device_specs", "voltage_range", "authors"])
